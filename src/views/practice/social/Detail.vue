<template>
  <div class="social-practice-detail-container">
      ...
      <template #header>
        <div class="card-header">
          <div class="header-left">
            ...
            <span class="header-title">社会实践详情</span>
          </div>
...
const handleEdit = () => {
  router.push(`/practice/social/edit/${detail.value.id}`)
}
...
.social-practice-detail-container {
  .card-header {
    display: flex;
    align-items: center;
