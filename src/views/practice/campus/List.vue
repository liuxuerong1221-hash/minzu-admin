<template>
  <div class="campus-practice-list-container">
    <!-- 搜索栏 -->
...
const handleCreate = () => {
  router.push('/practice/campus/create')
}

const handleEdit = (row) => {
  router.push(`/practice/campus/edit/${row.id}`)
}

const handleView = (row) => {
  router.push(`/practice/campus/detail/${row.id}`)
}
...
.campus-practice-list-container {
  .search-card,
  .toolbar-card,
  .table-card {
    margin-bottom: 20px;
